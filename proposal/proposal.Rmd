...
Questions:
- How do we use date on the x axis when not every observation has the same time in between?
- What is causing all the warnings and the nonfunctioning of plots?
